    ...
    <div class="container-fluid">
      ...
      <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
          ...
          <ul class="navbar-nav justify-content-start flex-grow-1 pe-3">
            <li class="nav-item">
              <a class="nav-link" href="abas/terror.php">Terror</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="abas/romance.php">Romance</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="abas/fantasia.php">Fantasia</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="abas/misterio.php">Misterio</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="abas/infantil.php">Infantil</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <?php
                    ...
                    if(isset($_SESSION['nome'])){
                        ...
                        echo "
                        <a class='navbar-brand' href='abas/perfil.php'>
                        <img src='img/icones/login.svg' alt='login&cadastro' width='30px'>
                        </a>
                        <a class='navbar-brand' href='abas/logout.php'>
                          <img src='img/icones/saida.png' alt='login&cadastro' width='30px'>
                        </a>
                        ";
                    }
                    else{
